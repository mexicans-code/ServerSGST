...
export const enviarBoleto = async (datosReserva) => {
    const { email, nombre, id_reserva, id_pago, hosteleria, fecha_inicio, fecha_fin, total, reservationId, personas } = datosReserva;
            ...
            <style>
                * { margin: 0; padding: 0; box-sizing: border-box; }
                ...
                @media only screen and (max-width: 600px) {
                    ...
                    .date-block { display: block; width: 100%; border: none !important; }
                    .date-block:first-child { border-bottom: 2px solid #dee2e6 !important; }
                }
            </style>
        </head>
        <body>
                ...
                <div class="content">
                    ...
                    <div class="property-card">
                        <div class="property-header">
                            <div class="property-name">${hosteleria.nombre}</div>
                            <div class="property-location">📍 ${hosteleria.ubicacion}</div>
                        </div>
